...
public class Point implements Comparable<Point> {
    ...
    private class SlopeComparator  implements Comparator <Point> {
    	...
    	private  SlopeComparator (Point a) {
    		origin = a;
    		
    	}
    	@Override
		public int compare(Point arg0, Point arg1) {
			Slope1 = origin.slopeTo(arg0);
			Slope2 = origin.slopeTo(arg1);
    ...
    public static void main(String[] args) {
        ...
        Comparator <Point> SlopeCompare= a.slopeOrder();
        System.out.println (SlopeCompare.compare(b, c));
